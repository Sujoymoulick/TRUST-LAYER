        ...
        <div className="p-4 sm:p-5 border-b-[3px] border-[var(--border-color)] flex items-center justify-between">
          <div className="flex flex-col">
            <span className="flex items-center gap-1.5 sm:gap-2">
              <img src={mainLogo} alt="Crifolayer Logo" className="h-6 sm:h-8 w-auto object-contain" />
              <span className="font-display text-base sm:text-lg uppercase italic font-black text-[var(--text-primary)] tracking-tight">Crifolayer</span>
            </span>
            {isGuest && (
