    ...
    <div className="min-h-screen bg-white flex flex-col items-center justify-center p-6 font-body">
      <div className="max-w-md w-full brutal-card space-y-8 text-center py-12">
        ...
        <div className="relative inline-block">
          <div className="w-32 h-32 border border-slate-200 dark:border-zinc-800 rounded-full overflow-hidden bg-gray-100 mx-auto">
            <img src="https://api.dicebear.com/7.x/avataaars/svg?seed=orla" alt="avatar" />
          </div>
          <div className="absolute bottom-0 left-1/2 -translate-x-1/2 translate-y-1/2 bg-brutal-green border border-slate-200 dark:border-zinc-800 px-4 py-1 flex items-center gap-2 whitespace-nowrap">
        ...
        {/* Stats Grid */}
        <div className="grid grid-cols-3 border border-slate-200 dark:border-zinc-800 bg-white">
          <div className="p-4 border-r border-slate-200 dark:border-zinc-800">
             <div className="text-[10px] font-bold uppercase text-gray-400 mb-1">Jobs Completed</div>
             <div className="font-display text-2xl">150</div>
          </div>
          <div className="p-4 border-r border-slate-200 dark:border-zinc-800">
             <div className="text-[10px] font-bold uppercase text-gray-400 mb-1">Average Review</div>
             <div className="font-display text-2xl">4.9/5</div>
          </div>
          <div className="p-4">
             <div className="text-[10px] font-bold uppercase text-gray-400 mb-1">Response Time</div>
