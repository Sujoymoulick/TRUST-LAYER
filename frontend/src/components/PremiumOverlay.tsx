  ...
  return (
    <div className="relative group overflow-hidden rounded-sm">
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center bg-black/5 backdrop-blur-[2px] z-10 p-4">
        <div className="brutal-card bg-white border border-slate-200 dark:border-zinc-800 text-center max-w-md mx-auto shadow-lg">
          <div className="w-16 h-16 bg-brutal-yellow text-black flex items-center justify-center mx-auto mb-4 border border-slate-200 dark:border-zinc-800 shadow-md">
          ...
          <button 
            ...
            className="w-full brutal-btn bg-[#00E5FF] text-black font-bold uppercase py-4 border border-slate-200 dark:border-zinc-800 hover:bg-black hover:text-[#00E5FF] transition-colors shadow-md"
          >
