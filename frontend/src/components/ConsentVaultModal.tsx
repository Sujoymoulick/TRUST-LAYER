        ...
        {!success ? (
          <div className="space-y-5">
            ...
            <div className="p-3 bg-gray-50 border-2 border-black space-y-2 text-xs font-semibold text-gray-700 leading-relaxed">
              <p>
                <span className="font-black text-black">Crifolayer</span> is requesting a user-as-agent secure proxy delegation to your <span className="font-black text-black text-brutal-blue uppercase">{providerName}</span> account.
              </p>
