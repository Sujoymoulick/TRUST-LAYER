...
export const CircularTestimonialsDemo = () => (
  <section className="space-y-8 w-full">
    ...
    <div className="bg-[#f7f7fa] dark:bg-zinc-900/40 p-8 sm:p-20 rounded-lg min-h-[300px] flex flex-wrap gap-6 items-center justify-center relative border border-zinc-200 dark:border-zinc-800">
      <div
    ...
    <div className="bg-[#060507] p-8 sm:p-16 rounded-lg min-h-[300px] flex flex-wrap gap-6 items-center justify-center relative border border-zinc-900">
      <div
        className="items-center justify-center relative flex w-full"
